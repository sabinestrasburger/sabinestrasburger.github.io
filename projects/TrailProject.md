...
I chose to prove how you would derive the formula for trail, which is the area where the front wheel of a bike touches the ground to where (if you'd draw a straight line down from) the steering access to the ground. Calculating trail is an important factor in understanding the handling capabilities of a bike. This formula can be used for either bicycles or motorcycles. You can read more about trail [here](https://en.wikipedia.org/wiki/Bicycle_and_motorcycle_geometry#Trail)
